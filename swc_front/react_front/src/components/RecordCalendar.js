...
const RecordCalendar = () => {
  ...
  return (
    ...
    <div className="container">
        ...
        <div className="rectangle3-calendar"></div>
        <div className="icon-calendar"><img className="icon-image-calendar" src="icon1.PNG"></img></div>
        <div className="lookAtMe-calendar">Look At Me!</div>
        <div className="unnamed-calendar">당신의 집중도를 기록해보세요.</div>
        <div className="title">
            <h3>
        ...
        <div className="bottom-bar">
          <button className="go-to-webcam"><Link to="/" style={{ color:"white", textDecoration: "none" }}>Back to Webcam</Link></button>
        </div>
    </div>
  );
};
